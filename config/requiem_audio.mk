...
ALARM_PATH := vendor/requiem/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/requiem/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/requiem/prebuilt/common/media/audio/ringtones
